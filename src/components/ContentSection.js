    ...
    <section className="py-16 bg-white dark:bg-black">
      <div className="container mx-auto max-w-4xl px-4">
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg mb-8 border border-slate-200 dark:border-gray-700">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="text-center">
              <div className="bg-gray-100 dark:bg-gray-800 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="fas fa-code text-black dark:text-white text-xl"></i>
              </div>
              <h4 className="font-semibold text-slate-800 dark:text-white mb-2">Clean Code</h4>
            ...
            <div className="text-center">
              <div className="bg-gray-100 dark:bg-gray-800 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="fas fa-shield-alt text-black dark:text-white text-xl"></i>
              </div>
              <h4 className="font-semibold text-slate-800 dark:text-white mb-2">Security First</h4>
              <p className="text-sm text-slate-600 dark:text-gray-400">
            ...
            <div className="text-center">
              <div className="bg-gray-100 dark:bg-gray-800 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="fas fa-rocket text-black dark:text-white text-xl"></i>
              </div>
              <h4 className="font-semibold text-slate-800 dark:text-white mb-2">Performance</h4>
              <p className="text-sm text-slate-600 dark:text-gray-400">
